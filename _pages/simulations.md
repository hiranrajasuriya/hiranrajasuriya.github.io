...
In the context of continuous wavelet transforms (CWT), there are many wavelet families defined such as Shannon, Mexican hat, Morlet, etc. depending on the application. However, the drawbacks of CWT include highly redundant computations which leads to the requirement of additional computational power and time consumption. Avoiding this, in discrete wavelet transform (DWT), the scaling and translation are performed in a discrete manner.

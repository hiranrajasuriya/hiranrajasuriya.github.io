...
My current research interests lie in sparse signal processing, structured sparsity, compressed sensing and inverse problems in imaging, for which I am remotely collaborating with <a href="https://scholar.google.com/citations?hl=en&user=xplw9-gAAAAJ">Prof. Marco F. Duarte </a>. More broadly, I am keen on optimization and statistical learning theory. Before my current exploration in the theoretical domain, I had experience and publications in application-oriented research where I discovered my passion for underlying geometric and algebraic structures, and how to exploit these structures for resource efficient and robust machine learning models.
